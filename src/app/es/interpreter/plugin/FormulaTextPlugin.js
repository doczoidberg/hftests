...
export var FormulaTextPlugin = /*#__PURE__*/function (_FunctionPlugin) {
  ...
  _createClass(FormulaTextPlugin, [{
     ...
     */
    value: function formulatext(ast, formulaAddress) {
      var _this = this;
      ...
      return this.runFunctionWithReferenceArgument(ast.args, formulaAddress, this.metadata('FORMULATEXT'), function () {
        ...
        return _this.serialization.getCellFormula(cellReference) || new CellError(ErrorType.NA);
      }, function () {
        return new CellError(ErrorType.NA);
      });
    }
